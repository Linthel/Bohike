...
{
    public class Torch : Hurtbox
    {
        public Torch(Texture2D texture)
          : base(texture)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (Target != null)
            {
                Velocity += Vector2.Normalize(new Vector2(Target.Position.X - Position.X, Target.Position.Y - Position.Y)) * 0.05f;
            ...
            Rotation = Game1.Random.Next(0, 360);
