...
namespace Bohike.States.Levels
{
    public class LevelAir : State
    {
        ...
        public LevelAir(Game1 game, GraphicsDevice graphicsDevice, ContentManager content) 
            : base(game, graphicsDevice, content)
        {
            ...
            var backgroundMusic = _content.Load<Song>("Audio/Music/AirLevelMusic");
