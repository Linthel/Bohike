...
namespace Bohike.States.Levels
{
    public class LevelEarth : State
    {
        ...
        public LevelEarth(Game1 game, GraphicsDevice graphicsDevice, ContentManager content) 
            : base(game, graphicsDevice, content)
        {
            // --- TEXTURES ---
            _staticBackgroundTexture = _content.Load<Texture2D>("Video/Backgrounds/LevelEarth/StaticBackground");

            _farBackground1Texture = _content.Load<Texture2D>("Video/Backgrounds/LevelEarth/FarBackground1");
            _farBackground2Texture = _content.Load<Texture2D>("Video/Backgrounds/LevelEarth/FarBackground2");
            _farBackground3Texture = _content.Load<Texture2D>("Video/Backgrounds/LevelEarth/FarBackground3");
