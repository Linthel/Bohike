...
namespace Bohike.States.Levels
{
    public class LevelFire : State
    {
        ...
        public LevelFire(Game1 game, GraphicsDevice graphicsDevice, ContentManager content) 
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(_farBackgroundTexture, new Rectangle(0, 0, (int)(Game1.ScreenWidth), (int)(Game1.ScreenHeight)), new Rectangle((int)( _farBackgroundPosition.X), 0, _farBackgroundTexture.Width, _farBackgroundTexture.Height), Color.White);
            spriteBatch.End();

            /// --- MID BACKGROUND(S) ---

            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.LinearWrap);
            spriteBatch.Draw(_midBackgroundTexture, new Rectangle(0, 0, (int)(Game1.ScreenWidth), (int)(Game1.ScreenHeight)), new Rectangle((int)(_midBackgroundPosition.X), 0, _midBackgroundTexture.Width, _midBackgroundTexture.Height), Color.White);
            spriteBatch.End();
