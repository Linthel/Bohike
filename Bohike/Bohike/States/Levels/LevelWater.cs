...
namespace Bohike.States.Levels
{
    public class LevelWater : State
    {
        ...
        private Texture2D _farBackground1Texture;
        private Texture2D _farBackground2Texture;
        private Texture2D _farBackground3Texture;
        private Vector2 _midBackgroundPosition;
        private Vector2 _frontBackgroundPosition;
        private Vector2 _farBackgroundPosition;

        public LevelWater(Game1 game, GraphicsDevice graphicsDevice, ContentManager content)
            : base(game, graphicsDevice, content)
        {
            // --- TEXTURES ---
            _staticBackgroundTexture = _content.Load<Texture2D>("Video/Backgrounds/LevelWater/StaticBackground");

            _farBackground1Texture = _content.Load<Texture2D>("Video/Backgrounds/LevelWater/FarBackground1");
            _farBackground2Texture = _content.Load<Texture2D>("Video/Backgrounds/LevelWater/FarBackground2");
            _farBackground3Texture = _content.Load<Texture2D>("Video/Backgrounds/LevelWater/FarBackground3");
            ...
            var backgroundMusic = _content.Load<Song>("Audio/Music/WaterLevelMusic");
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(_farBackground1Texture, new Rectangle(0, 0, (int)(Game1.ScreenWidth), (int)(Game1.ScreenHeight)), new Rectangle((int)(_farBackgroundPosition.X / 4), (int)(_farBackgroundPosition.Y), _farBackground1Texture.Width, _farBackground1Texture.Height), Color.White);
            spriteBatch.End();

            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.LinearWrap);
            spriteBatch.Draw(_farBackground2Texture, new Rectangle(0, 0, (int)(Game1.ScreenWidth), (int)(Game1.ScreenHeight)), new Rectangle((int)(_farBackgroundPosition.X / 2), (int)(_farBackgroundPosition.Y), _farBackground2Texture.Width, _farBackground2Texture.Height), Color.White);
            spriteBatch.End();

            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.LinearWrap);
            spriteBatch.Draw(_farBackground3Texture, new Rectangle(0, 0, (int)(Game1.ScreenWidth), (int)(Game1.ScreenHeight)), new Rectangle((int)(_farBackgroundPosition.X), (int)(_farBackgroundPosition.Y), _farBackground3Texture.Width, _farBackground3Texture.Height), Color.White);
            spriteBatch.End();
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _farBackgroundPosition.X += (float)(_mousePosition.X - Game1.ScreenWidth / 2) / 100;
